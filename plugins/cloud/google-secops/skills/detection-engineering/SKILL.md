...
description: >-
  ...
  and long-running coverage analysis.
---
...
- Inspect the validation response:
  ...
  - Never proceed to testing or deployment with unvalidated or failing rule syntax.
...
- **Long-Running Operation Polling Procedure**:
  ...
  - If `schedule` is unavailable, poll with available delay tools or turn boundaries. Never poll in a continuous tight loop.
- **Strict Gating Rule**:
