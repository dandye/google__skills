...
description: >-
  ...
  and closing or escalating alerts and cases.
---
...
1. **Document Triage Rationale**:
   ...
   - Include standard closing summary:
     ...
     - **Rule Tuning Recommendation**: <Suggested whitelist or UDM filter adjustment>
     ```
...
2. **Document Findings & Timeline**:
   - Post an escalation dossier covering:
     - Reconstructed timeline of events.
     - Confirmed IoCs and affected entities.
     - Recommended containment actions (e.g., host isolation, credential revocation).
3. **Pivoting to Hunting or Deep Investigation**:
   - Refer to `secops-hunt` for proactive lateral movement discovery and retroactive lookbacks.
